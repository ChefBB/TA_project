...
of the preprocessing phase, as will be described in section~\ref{preprocessing}.
...
The next critical step was stanza splitting. After cleaning the strings from
...
representing individual stanzas (each stanza has also a header with the corresponding keyword; this aspect will be discussed in the next paragraph).
