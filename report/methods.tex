...
testing, with parameters to aid further experimentation. Both the Recurrent
Neural Network and One-Dimensional Convolutional Neural Network share the same
preprocessing steps, including Non-Negative Matrix Factorization applied to title
for extracting latent topics, in addition to TF-IDF for richer text representation.
